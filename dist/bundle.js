        ...
        doubleDomArray.forEach((row, x) => {
            row.forEach((element, y) => {
                ...
                const clickHandler = function(event) {
                  const allShipSunk =  _logic_board_logic__WEBPACK_IMPORTED_MODULE_0__.gameBoardModule.hitTheBoardArray(board, leftBoardShip, [x, y]);
        ...
        while(shipsPosition.length>0)
        {
           ...
           console.log(unitsPlaced,"--> The End")
            ...
            if (unitsPlaced === 10) {
               ...
               _Dom_Manipulation__WEBPACK_IMPORTED_MODULE_5__.DomManipulationModule.getPositionHitFromTheBoardDom(boardLeft.ArrayBoard,leftBoardShip)
